INSERT INTO students (id, nm, email, major) VALUES 
            ('11101', 'Sheena Wyre', 'swyre0@un.org', 'Computer Science'),
            ('11100', 'Dilly Caffery', 'dcaffery1@blogspot.com', 'Civil Engineering'),
            ('22200', 'Marysa Alyonov', 'malyonov3@utexas.edu', 'Microbiology'),
            ('22201', 'Julie Venturoli', 'jventuroli4@marketwatch.com', 'Finance'),
            ('22202', 'SFrieda Liddiatt', 'fliddiatt6@yahoo.co.jp', 'Accounting');

INSERT INTO courses(dept, num, nm, descrip) VALUES
            ('SE', 452, 'Object-Oriented Enterprise Computing', 'This course focuses on applying object-oriented techniques in
            ...
            ('SE', 433, 'Software Testing and Quality Assurance','This course is designed for the software engineering
